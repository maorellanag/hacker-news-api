...
public class JwtService {
    ...
    public String generateToken(String user) {
        return buildToken(new HashMap<>(), user, securityProperties.getExpirationTime());
    }

    private String buildToken(Map<String, Object> extraClaims, String user, long expiration) {
        return Jwts.builder()
